...
const KEY_LABELS: Record<string, string> = {
  anthropic: "Claude AI", fal: "Seedance / fal.ai",
  ...
  return (
    <div className="view-grid master-dash">
      ...
      <section className="panel dash-health">
        ...
        {health && !health.keys["fal"] && (
          <div className="health-tip">
            <AlertTriangle size={14} />
            <span>Add <code>FAL_KEY</code> to <code>.env</code> to enable live Seedance video rendering.</span>
          </div>
        )}
      </section>
        ...
        <div className="panel">
          ...
          {ps ? (
            <div className="launch-gate-list">
              {[
                { label: "12 episodes complete", done: ps.episodes_completed >= 12, value: `${ps.episodes_completed}/12` },
                { label: "30 teaser days scheduled", done: ps.teaser_days_scheduled >= 30, value: `${ps.teaser_days_scheduled}/30` },
                { label: "Character sheets locked", done: ps.character_sheets_locked, value: ps.character_sheets_locked ? "Done" : "Pending" },
                { label: "Trailer complete", done: ps.trailer_complete, value: ps.trailer_complete ? "Done" : "Pending" },
              ].map((item) => (
